...
public class StudentController {
    ...
    public String registerStudent(@jakarta.validation.Valid @ModelAttribute Student student, org.springframework.validation.BindingResult bindingResult, Model model, RedirectAttributes redirectAttributes) {
