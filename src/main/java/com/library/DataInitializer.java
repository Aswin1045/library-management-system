...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        if (studentRepository.count() == 0) {
            // Sample Students
            studentRepository.save(new Student("Rahul Kumar", "rahul@email.com", "password123", "Computer Science"));
            studentRepository.save(new Student("Priya Sharma", "priya@email.com", "password123", "Information Technology"));
            studentRepository.save(new Student("Arun Nair", "arun@email.com", "password123", "Electronics"));
        ...
        if (librarianRepository.count() == 0) {
            // Sample Librarian
            librarianRepository.save(new Librarian("admin", "admin123"));
